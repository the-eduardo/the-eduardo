...
# C:\Users\eduar\.config\powershell\omp\night-owl-mod.omp.json
oh-my-posh init pwsh --config 'C:\Users\eduar\.config\powershell\omp\updated-night-owl.omp.json' | Invoke-Expression
# oh-my-posh init pwsh --config "$env:C:\Users\eduar\.config\powershell\omp/my-new-theme.json" | Invoke-Expression
# oh-my-posh init pwsh --config "$env:C:\Users\eduar\.config\powershell\poshmon.omp.json" | Invoke-Expression
...
Set-Alias bb BF4DB
Set-Alias q 'C:\Users\eduar\scoop\shims\qalc.exe'
Set-Alias ee 'C:\Program Files\Elixir\bin\iex.bat'
